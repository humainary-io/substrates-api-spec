...
- **[SPEC.md](SPEC.md)** — The Substrates Specification (Version 3.0.3)
...
- **Core abstractions** — Cortex, Circuit, Source, Conduit, Pool, Bank, Sink, Pipe, Receptor,
  Subscriber, Subscription, Fiber, Flow, Window, Capture, Cell, Basin, Port, Pin, Ticker, and their
  relationships
